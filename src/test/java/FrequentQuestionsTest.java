...
import pageobject.FrequentQuestionsPage;
...
public class FrequentQuestionsTest extends AbstractUiTestParent {
    ...
    public void checkAnswersForQuestions() throws InterruptedException {
        ...
        FrequentQuestionsPage frequentQuestionsPage = new FrequentQuestionsPage(driver);

        String answer = frequentQuestionsPage.getAnswerFor(question);

        Assert.assertEquals("Ожидаемый ответ на вопрос отличается от полученного!", expectedAnswer, answer);
    }
